...
import { Quote, User, Trophy, Target, Users, Star, Camera } from "lucide-react";

const Founder = () => {
  const teamMembers = [
    { name: "Cheif Executive Officer", role: "Subramanyam Chowdary", color: "from-blue-500 to-cyan-500" },
    { name: "Co-Founder", role: "Bhavya Sree", color: "from-pink-500 to-rose-500" },
    { name: "Chief Technology Officer", role: "Roshan Zameer", color: "from-purple-500 to-pink-500" },
    { name: "Cheif Operating Officer", role: "Mohith", color: "from-green-500 to-emerald-500" },
    { name: "Project Manager", role: "Balaji", color: "from-orange-500 to-red-500" },
    { name: "Head of Growth", role: "Arshad", color: "from-indigo-500 to-purple-500" },
    { name: "Social Media Manager", role: "Sai Lalith", color: "from-blue-500 to-cyan-500" },
